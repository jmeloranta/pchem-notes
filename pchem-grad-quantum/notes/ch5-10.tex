...
Here * denotes complex conjugation. here the matrices will be real and the complex conjugation will have no effect. Note that the indices $i,j$ and $i',j'$ refer to the elements within the matrix. The summation runs over all possible symmetry operations $R$ in the group.
