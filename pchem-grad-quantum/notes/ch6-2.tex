...
Note that it might be possible that two levels in the set are degenerate and special precautions must be taken in sch cases. In this 
...
In the following we will be calculating the perturbed form of the state $\left|0\right>$ of energy $E_0^{(0)}$, which is not necessarily the ground state of the system. The hamiltonian for the perturbed system is written as:
