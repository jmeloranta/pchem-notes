...
where $J = 0, 1, 2, ...$ and $M_J = 0, \pm 1, \pm 2, ..., \pm J$. Because the energy is independent of $M_J$, each rotational level is $2J + 1$ times degenerate. 
...
\otext
Next, $I = \mu R^2$ gives the moment of inertia:
