...
% New equation4: (1) eq number (2) equation line 1, (3) equation line 2, (4) line 3, (5) line 4.
\newcommand{\eeqn}[6]{\vspace{-5pt}\begin{eqnarray}\label{eq#1} & & #2\phantom{X}\\ & & #3\nonumber\\ & & #4\nonumber\\ & & #5\nonumber\\ & & #6\nonumber\end{eqnarray}}

% New equation4: (1) eq number (2) equation line 1, (3) equation line 2, (4) line 3, (5) line 4.
\newcommand{\feqn}[7]{\vspace{-5pt}\begin{eqnarray}\label{eq#1} & & #2\phantom{X}\\ & & #3\nonumber\\ & & #4\nonumber\\ & & #5\nonumber\\ & & #6\nonumber\\ & & #7\nonumber\end{eqnarray}}

% New page
\newcommand{\opage}[1]{\begin{frame}[plain]\hfill\thepage\\ #1\end{frame}}

% New page (fragile) - allows verbatim -- doesn't work as a macro for some reason!?
%\newcommand{\opagef}[1]{\begin{frame}[fragile]\hfill\thepage\\ #1\end{frame}}
...
\newcommand{\sijoitus}[2]{\operatornamewithlimits{\Bigl/}\limits_{\!\!\!#1}^{\,#2}}
