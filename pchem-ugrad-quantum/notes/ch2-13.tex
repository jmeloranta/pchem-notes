...
as well as the total angular momentum (e.g. $J = L + S$). This is expressed as follows:
...
\otext
\textbf{Solution.} The electron configuration in He is 1s$^2$ (e.g. two electrons on 1s orbital with opposite
...
Thus we conclude that for $L = 2$, only the singlet state (e.g. $^1$D) is possible.
...
\otext
All these cases can also be written for the triplet state because the electrons always occupy different orbitals. Hence we conclude that both singlet and triplet states are allowed for the P term (e.g. $^1$P and $^3$P).
