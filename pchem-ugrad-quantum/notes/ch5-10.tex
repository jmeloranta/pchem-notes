...
As we are still missing the three molecular vibrational normal modes, this does not add up to $(9, -1, 1, 3)$ but $(6, -2, 0, 0)$. To make the two characters match, we have to include $2\times A_1$ and $B_2$, which add up to the following character:
...
& & A_1\times A_1\times A_1 = (A_1\times A_1)\times A_1 = A_1\times A_1 = A_1 \textnormal{(contributes)}\nonumber
\end{eqnarray}
