...
\item \underline{Spin-spin relaxation ($T_2$):} If the individual spins in the $xy$-plane start to fan-out because their Larmor frequencies are slightly different, the total magnetization will be reduced as there will be a partial cancellation of the magnetic moments of the individual spins in $xy$ (``out of phase''). The spins are said to lose their coherence the $xy$-plane. $T_2$ is also called the \textit{transverse relaxation time}.
\end{enumerate}
