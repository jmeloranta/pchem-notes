...
\otext
Symmetry operations can be performed on any object defined over the molecule. For example, a $C_2$ operation on a $s$ and $p$ orbitals can visualized as follows:
