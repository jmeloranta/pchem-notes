...
where $\omega$ is the angular velocity (rad/s), $I$ is the moment of inertia (Eq. (\ref{eqn5.45})) and $L$ is the angular momentum. For an object that can rotate in 3D, we have to account for rotation about each axis:
