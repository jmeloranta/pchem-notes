...
\otext
In the following we will consdier two common sources of line broadening present in specroscopic experiments.
...
where $c$ is the speed of light. For nonrelativistic speeds ($s << c$), these expressions simplify to:
