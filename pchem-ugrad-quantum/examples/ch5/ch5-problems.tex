...
\ifthenelse{\equal{\solutions}{true}}{\input{ch5-solution-1}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch5-solution-2}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch5-solution-5}}{}

\noindent
6. The dissociation energy ($D_0$) of H$_2$ is 4.46 eV with the zero-point energy being 0.26 eV. What is the value of $D_0$ for D$_2$ molecule?\\

\ifthenelse{\equal{\solutions}{true}}{\input{ch5-solution-6}}{}

\noindent
7. IR measurement of gaseous HCl sample yields the following Morse potential constants: $\tilde{\nu}_e = 2990.1$ cm$^{-1}$ and $x_e = 0.01737$. What is the dissociation energy $D_0$? How does this compare with the known dissociation energy of HCl?\\

\ifthenelse{\equal{\solutions}{true}}{\input{ch5-solution-7}}{}

\noindent
8. How many rotational and vibrational degrees of freedom do the following molecules have: CH$_2$O, C$_2$H$_2$, and C$_6$H$_6$?\\

\ifthenelse{\equal{\solutions}{true}}{\input{ch5-solution-8}}{}

\noindent
9. Which of the following molecular vibrations of benzene are IR or Raman active?
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch5-solution-9}}{}
