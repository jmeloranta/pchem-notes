...
\textbf{Example.} Consider an adiabatic, reversible expansion of 0.020 mol Ar (ideal gas), initially at 25 \degree C, from 0.50 L to 1.00 L. What is the final temperature and how much work is done?

\vspace*{0.2cm}

\textbf{Solution.} First we have to modify Eq. (\ref{eq2.83}):
...
From the temperature difference we can calculate the work ($\bar{C}_V = 12.47$ J K$^{-1}$ mol$^{-1}$; ideal gas):

\vspace*{-0.2cm}

$$w_{rev} = n\bar{C}_V\Delta T$$
$$= \left(0.020\textnormal{ mol}\right)\times\left(12.47\textnormal{ J K}^{-1}\textnormal{ mol}^{-1}\right)$$
