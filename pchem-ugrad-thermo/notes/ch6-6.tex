...
For ideal gases we have $P_i = y_i P$ and the above equation can be written in this case:
...
\item Three different concentration scales can be used with Henry's law:\\
