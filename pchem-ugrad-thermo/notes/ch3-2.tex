...
\otext
\textbf{Example.} Is the expansion of an ideal gas into a larger volume thermodynamically spontaneous? More specifically, consider reversible and isothermal expansion of an isolated ideal gas ($n = 1$ mol) initially at 298 K into a volume that is twice as large as its initial volume.
