...
\textbf{Example.} Show that the values of the line integral for $dq_{rev} / T$ are identical along the following paths (monoatomic ideal gas, reversible processes, $n = 1$):
