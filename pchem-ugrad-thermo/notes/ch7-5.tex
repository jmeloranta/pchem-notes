...
$$A = \frac{1}{2.303}\left(\frac{2\pi N_Am_{solv}}{V}\right)^{1/2}\left(\frac{e^2}{4\pi\epsilon_0\epsilon_rkT}\right)^{3/2}$$
$$ = \frac{1}{2.303}\left(\frac{2\pi\left(6.022\times 10^{23}\textnormal{ mol}^{-1}\right)\left(997\textnormal{ kg}\right)}{\left(1.000\textnormal{ m}^{3}\right)}\right)^{1/2}$$
$$\times\left(\frac{\left(1.602\times 10^{-19}\textnormal{ C}\right)^2}{4\pi\left(8.854\times 10^{-12}\textnormal{ AsV}^{-1}\textnormal{m}^{-1}\right)\left(78.54\right)\left(1.3861\times 10^{-23}\textnormal{JK}^{-1}\right)\left(298.2\textnormal{ K}\right)}\right)^{3/2}$$
