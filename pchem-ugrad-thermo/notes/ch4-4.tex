...
\otext
\textbf{Example.} Given the expression for the molar Gibbs energy (Eq. (\ref{eq4.68})) and considering a monatomic ideal gas, derive the corresponding expression for the following thermodynamic properties: $V, U, H, S$ and $A$ at constant $T$.
