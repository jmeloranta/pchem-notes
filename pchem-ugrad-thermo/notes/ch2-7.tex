...
$$H_{\begin{matrix}\textnormal{\tiny apparatus}\\\textnormal{\tiny cools}\end{matrix}} = C_{\textnormal{\tiny calorimeter}}\Delta T = \left(10.0\textnormal{ J K}^{-1}\right)\times\left(T_f - 303\textnormal{ K}\right)$$
