...
\beqn{5.30e}{K = \left(\frac{P}{P^\circ}\right)^{m-1}\times\left(\frac{1 - \xi_{eq}}{1 - \xi_{eq}\left(1 - m\right)}\right)^{-1}\times\left(\frac{\xi_{eq}m}{1 - \xi_{eq}\left(1 - m\right)}\right)^m}{ = \left(\frac{P/P^\circ}{1 - \xi_{eq}\left(1 - m\right)}\right)^{m-1}\times\frac{\left(\xi_{eq}m\right)^m}{\left(1 - \xi_{eq}\right)^m}}
...
$$\xi = \frac{M_{ini} - M_{eq}}{M_{eq}} = \frac{\left(92.01\textnormal{ g mol}^{-1}\right) - \left(77.70\textnormal{ g mol}^{-1}\right)}{77.70\textnormal{ g mol}^{-1}} = 0.1842$$
