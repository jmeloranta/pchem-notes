...
{\approx -x \textnormal{ when higher order terms are ignored.}}
...
Where $\Delta T_f$ indicates the change (i.e. depression) in freezing point. In this context the concentration is often given in terms of molal concentrations $m$ (i.e. moles of solute per kilogram of solvent). The relation between these concentrations is:

\aeqn{6.66}{x_{\textnormal{B}} = \frac{m_{\textnormal{B}}}{1 / M_{\textnormal{A}} + m_{\textnormal{B}}} \approx m_{\textnormal{B}}M_{\textnormal{A}}}
