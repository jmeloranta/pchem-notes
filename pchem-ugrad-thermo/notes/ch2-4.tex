...
\underline{Note:} $\left|w_{comp}\right| > \left|w_{exp}\right|$. More work is required to compress the gas than can be obtained by expansion. This process is \textbf{irreversible}. Such behavior results from heat flow ($q$; not discussed yet).
