...
$\Delta \bar{H} = -6004$ kJ mol$^{-1}$, $\bar{C}_{liq} = 75.3$ J K$^{-1}$ mol$^{-1}$, $\bar{C}_{ice} = 36.8$ J K$^{-1}$ mol$^{-1}$.
...
\ceqn{3.38}{\Delta \bar{S}_{syst} = \int\limits_{263\textnormal{ K}}^{273\textnormal{ K}}\frac{\bar{C}_{liq}}{T}dT + \frac{\Delta H}{T} + \int\limits_{273\textnormal{ K}}^{263\textnormal{ K}}\frac{\bar{C}_{ice}}{T}dT = \left(75.3\textnormal{ J K}^{-1}\textnormal{ mol}^{-1}\right)\hspace*{1cm}}
