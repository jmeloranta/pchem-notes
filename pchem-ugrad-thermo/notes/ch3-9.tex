...
\otext
Because the internal energy of the system is a state function, the total change in internal energy over a closed path must be zero:
...
\aeqn{3.57}{\epsilon = \frac{\left|w_{cycle}\right|}{\left|q_{in}\right|} = \frac{\left|q_{in}\right| - \left|q_{out}\right|}{\left|q_{in}\right|} = 1 - \frac{\left|q_{out}\right|}{\left|q_{in}\right|}}
