...
\textbf{Solution.} Consider equilibrium reaction:\\

$$\textnormal{C(gra)} = \textnormal{C(dia)}$$

where $\Delta_r G^\circ = \Delta_fG^\circ (dia) - \Delta_fG^\circ (gra) = (2900 - 0)$ J/mol. Eq. (\ref{eq4.38}) can now be applied: $\Delta\bar{V} = \left(\frac{\partial (\Delta_r G)}{\partial P}\right)_{T,n}$. This can be integrated:

$$\int\limits_{\Delta_rG^\circ}^{\Delta_rG}d(\Delta_rG) = \int\limits_{P^\circ}^{P}\Delta\bar{V}dP$$

where $\Delta\bar{V} = \bar{V}(dia) - \bar{V}(gra)$. Integration of this equation leads to ($\Delta P = P - P^\circ$):

$$\Delta_r G = \Delta_r G^\circ + \Delta \bar{V} \Delta P$$
...
where $\Delta_r G = 0$ at equilibrium. Solving for $\Delta P$ gives:

$$\Delta P = \frac{\Delta_r G - \Delta_r G^\circ}{\Delta\bar{V}} = \frac{-2900\textnormal{ kJ/mol}}{-1.91\times 10^{-6}\textnormal{ m}^3/\textnormal{mol}} = 1.52\times 10^9\textnormal{ Pa}$$

and the change in molar volume is obtained from:

$$\bar{V} = \left( 12\textnormal{ g mol}^{-1}\right)\left(\frac{1}{3.51\textnormal{ g m}^{-3}} - \frac{1}{2.25\textnormal{ g m}^{-3}}\right)\times 10^{-6} = -1.91\times 10^{-6}\textnormal{ m}^3\textnormal{ mol}^{-1}$$

The required pressure is $P = P^0 + \Delta P \approx 1.52\times 10^9\textnormal{ Pa}$. Since the temperature was fixed at 25 $^\circ$C, this much pressure must be applied in order to reach the two-phase equilibrium (i.e., must be located on the phase boundary line).
