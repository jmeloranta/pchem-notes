...
The above derivations suffer from two approximations: 1) $\Delta_rH^\circ$ was assumed to be independent of temperature and 2) the gas phase was assumed to follow the ideal gas law. The temperature dependency can be included in $\Delta_rH^\circ$ approximately by assuming the following form (not a very good approximation either):
