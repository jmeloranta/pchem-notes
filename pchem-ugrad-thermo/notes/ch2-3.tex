...
$$\left(\frac{\partial N'}{\partial x}\right)_y = \left[\frac{\partial}{\partial x}\left(bx + 2cy\right)\right]_x = b$$
...
$$\int\limits_C u = \int\limits_0^2 (2x + 9)dx + \int\limits_3^7 (6 + 4y)dy = \left.\left(\frac{2x^2}{2} + 9x\right)\right|_0^2 + \left.\left(6y + \frac{4y^2}{2}\right)\right|_3^7 = 126$$
