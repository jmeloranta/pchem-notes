...
where $C_V$ was calculated from the relation $C_P - C_V = R$. The value of $C_P$ can be found from the NIST chemistry webbook. Note the handling of the process in two steps. The total change in entropy is the sum of the two: $\Delta S = 0.175$ J K$^{-1}$.
...
$$\Delta\bar{S} = \frac{5}{2}\ln\left(\frac{T_2}{T_1}\right) - R\ln\left(\frac{P_2}{P_1}\right) = \frac{5}{2}\ln\left(\frac{100\textnormal{ K}}{298\textnormal{ K}}\right) - R\ln\left(\frac{10\textnormal{ bar}}{1\textnormal{ bar}}\right) = -41.84\textnormal{ }\frac{\textnormal{J}}{\textnormal{K mol}}$$
