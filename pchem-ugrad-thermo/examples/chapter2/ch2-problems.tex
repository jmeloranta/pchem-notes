...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-1}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-2}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-3}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-4}}{}

\item One mole of nitrogen (ideal gas) at 25 $^\circ$C and 1.0 bar is expanded reversibly and isothermally to a pressure of 0.132 bar. (a) What is the value of $w$? (b) What is the value of $w$ if the nitrogen is expanded against a constant external pressure of 0.132 bar?

\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-5}}{}

\item \begin{itemize}

\item[(a)] Derive the equation for the work of reversible isothermal expansion of a van der Waals gas from $V_1$ to $V_2$.

\item[(b)] A mole of CH$_4$ expands reversibly from 1.0 to 50 L at 25 $^\circ$C. Calculate the work (in joules) assuming that the gas is ideal.
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-6}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-7}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-8}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-9}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-10}}{}
...
\ifthenelse{\equal{\solutions}{true}}{\input{ch2-solution-11}}{}
